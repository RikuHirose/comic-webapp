...
// top > writer_name > comic_name > レビュー
Breadcrumbs::for('comics.show.review.create', function ($trail, $comic) {
    $trail->parent('comics.show', $comic);
    $trail->push('レビュー', route('comics.show.review.create', $comic->comic_name));
});
